...
export type BuildingFilters = { search?: string; boroughs?: string[]; neighborhoods?: string[]; amenities?: string[]; priceRange?: string; bedrooms?: string; bathrooms?: string; moveInDate?: string; moveInFlex?: string; mapOnly?: boolean };
