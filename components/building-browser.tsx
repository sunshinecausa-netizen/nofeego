  ...
  const compactFilters = (
    <form onSubmit={onSubmit} role="search" className="border-y border-border bg-white px-3 py-3 shadow-sm sm:px-5">
      ...
      <div className="grid gap-2">
        ...
        <div className="grid min-w-0 grid-cols-[max-content_max-content_max-content_minmax(92px,138px)_minmax(108px,180px)_max-content_minmax(132px,1fr)] items-end gap-2">
        ...
        <Button type="submit" className="h-10 w-full min-w-[132px] whitespace-nowrap"><Search className="mr-2 h-5 w-5 shrink-0" /><span>Search</span></Button>
        </div>
        </div>
      </div>
