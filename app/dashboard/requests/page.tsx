...
type Inquiry = { id:string; building_id:string|null; request_type:'entire_place'|'roommate'|null; message:string|null; move_in_date:string|null; monthly_budget:number|null; contact_email:string|null; status:string; created_at:string };
